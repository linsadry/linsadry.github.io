// Icon.jsx — Componente SVG de ícones
export default function Icon({ name, size = 20, color = 'currentColor', style }) {
  ...
  const icons = {
    ...
    'chart-fill':<><rect x="5" y="14" width="4" height="6" fill={color} stroke="none"/><rect x="10" y="8" width="4" height="12" fill={color} stroke="none"/><rect x="15" y="11" width="4" height="9" fill={color} stroke="none"/></>,
    airplane:   <><path d="M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z"/></>,
    ...
    utensils:   <><path d="M3 2v7c0 1.1.9 2 2 2h4a2 2 0 0 0 2-2V2"/><line x1="7" y1="2" x2="7" y2="22"/><path d="M21 15V2a5 5 0 0 0-5 5v6c0 1.1.9 2 2 2h3zm0 0v7"/></>,
